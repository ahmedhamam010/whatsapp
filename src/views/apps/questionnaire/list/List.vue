      ...
      <b-card title="Survey List" > 
            ...
            <template #cell(actions)="data">
              ...
              >
                ...
                <b-dropdown-item :to="{ name: 'apps-questionnaires-view', params: { id: data.item.id } }">
                  <feather-icon icon="FileTextIcon" />
                  <span class="align-middle ml-50">Details</span>
                </b-dropdown-item>
                
                <b-dropdown-item :to="{ name: 'apps-questionnaires-edit', params: { id: data.item.id } }">
...
export default {
  ...
  methods:{
    redirectToAddForm(){
      router.replace('/apps/questionnaires/add')
    },
    deleteItem(id=0){
    ...
    getRecords(){
      this.isBusy = true
      this.isLoading = true
      var url = `questionnaires?paginate=${this.perPage}&page=${this.currentPage}`
      ...
      .then(response => {
         console.log('lessons:' , response.data.questionnaires )
         let data = response.data.questionnaires.data;
         this.rows= response.data.questionnaires.total
         this.perPage=response.data.questionnaires.per_page
         this.dataMeta.from = response.data.questionnaires.from
         this.dataMeta.to = response.data.questionnaires.to
         this.dataMeta.of = response.data.questionnaires.total
