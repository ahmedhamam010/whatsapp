              ...
              <b-row>
                ...
                >
                  <div class="d-flex align-items-center justify-content-end">
                    ...
                    >
                      <span class="text-nowrap">Add Field</span>
                    </b-button>
                  </div>
                </b-col>
            ...
            >
              ...
              <template #cell(actions)="data">
                ...
                >
                  ...
                  <b-dropdown-item :to="{ name: 'apps-fields-view', params: { id: data.item.id } }">
                    <feather-icon icon="FileTextIcon" />
                    <span class="align-middle ml-50">Details</span>
                  </b-dropdown-item>
                  
                  <b-dropdown-item :to="{ name: 'apps-fields-edit', params: { id: data.item.id } }">
...
export default {
  ...
  data(){
    return{
      ...
      items: [],
      currentPage: 1,
      perPage: this.$store.state.appConfig.fieldListPerPage,
      rows: null,
      fields : [
        { key: 'id',label: 'id' },
  ...
  methods:{
    redirectToAddForm(){
      router.replace('/apps/fields/add')
    },
    deleteItem(id=0){
    ...
    getRecords(){
      this.isLoading = true
      this.isBusy = true
      var url = `fields/consultation/index?paginate=${this.perPage}&page=${this.currentPage}`
    ...
    paginateChanged(paginate){
      this.$store.state.appConfig.fieldListPerPage = paginate
      this.currentPage = 1
      this.isBusy = true
