            ...
            >
              ...
              <template #cell(actions)="data">
                ...
                >
                  ...
                  <b-dropdown-item :to="{ name: 'apps-bank-questions-reply', params: { id: data.item.id } }">
...
export default {
  ...
  data(){
    return{
      ...
      items: [],
      currentPage: 1,
      perPage: this.$store.state.appConfig.userPendingBankQuestionListPerPage,
      rows: null,
      fields : [
        { key: 'id' },
  ...
  methods:{
    ...
    getRecords(){
      this.isBusy = true
      this.isLoading = true
      var url = `bank-questions/index/no?is_nurabi=0&paginate=${this.perPage}&page=${this.currentPage}`
    ...
    paginateChanged(paginate){
      this.$store.state.appConfig.userPendingBankQuestionListPerPage = paginate
      this.currentPage = 1
      this.isBusy = true
