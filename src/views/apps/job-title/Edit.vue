...
export default {
  ...
  mounted(){
        ...
        .catch(error => {
            ...
            console.log( 'job title error', error)
        })
  ...
  methods: {
    ...
    submitForm: function () {
        ...
        axios
          .post(`job-title/update/${this.id}`, formDataInputs, this.headersObj)
          .then(response => {
              console.log('jobTitle succuss' , response)
          ...
          .catch(error => {
            ...
            console.log('job title error' , error.response.data.message)
