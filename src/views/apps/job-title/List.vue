              ...
              <b-row>
                ...
                >
                  <div class="d-flex align-items-center justify-content-end">
                    ...
                    >
                      <span class="text-nowrap">Add Job Title</span>
                    </b-button>
                  </div>
                </b-col>
            ...
            >
              ...
              <template #cell(actions)="data">
                ...
                >
                  ...
                  <!-- <b-dropdown-item :to="{ name: 'apps-jobTitle-view', params: { id: data.item.id } }">
                    <feather-icon icon="FileTextIcon" />
                    <span class="align-middle ml-50">Details</span>
                  </b-dropdown-item> -->
                  
                  <b-dropdown-item :to="{ name: 'apps-jobTitle-edit', params: { id: data.item.id } }">
...
export default {
  ...
  data(){
    return{
      ...
      items: [],
      currentPage: 1,
      perPage: this.$store.state.appConfig.jobTitleListPerPage,
      rows: null,
      fields : [
        { key: 'id', label : 'id' },
  ...
  methods:{
    redirectToAddForm(){
       router.replace('/apps/jobTitle/add')
    },
    deleteItem(id=0){
            
      axios.delete(`job-title/destroy/${id}`, 
        {
    ...
    getRecords(){
      this.isLoading = true
      this.isBusy = true
      var url = `job-title/index?paginate=${this.perPage}&page=${this.currentPage}`
      ...
      .then(response => {
         ...
         console.log('job-title/index:' , response.data.data )
    ...
    paginateChanged(paginate){
      this.$store.state.appConfig.jobTitleListPerPage = paginate
      this.currentPage = 1
      this.isBusy = true
