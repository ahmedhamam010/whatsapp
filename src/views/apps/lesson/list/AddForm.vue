                  ...
                  ></vue-dropzone>
                    ...
                    <!-- <b-col md="6" v-if="showLiveInputs">
                          ...
                          <b-input-group class='mb-1'>
                            <b-form-input id='example-input' v-model='time' type='text' placeholder='HH:mm:ss' />
                            <b-input-group-append>
                              <b-form-timepicker v-model='time' button-only right show-seconds locale='en' aria-controls='example-input' />
                            </b-input-group-append>
                    ...
                    <b-col md="12">
                     ...
                     <!-- File -->
                      <b-col md="12" v-if="content_type != 'meet' ">
                        <b-form-group
                          label="File"
                          label-for="file"
                        >
...
export default {
  ...
  methods: {
    ...
    addAnalysisId: function(file){
        console.log(file.xhr.response.url);
        // this.file = file.xhr.response.url; 
