            ...
            >
              ...
              <template #cell(actions)="data">
                ...
                >
                  ...
                  <b-dropdown-item :to="{ name: 'apps-sliders-view', params: { id: data.item.id } }">
                    <feather-icon icon="FileTextIcon" />
                    <span class="align-middle ml-50">Details</span>
                  </b-dropdown-item>
                  
                  <b-dropdown-item :to="{ name: 'apps-sliders-edit', params: { id: data.item.id } }">
...
export default {
  ...
  data(){
    return{
      ...
      items: [],
      currentPage: 1,
      perPage: this.$store.state.appConfig.sliderListPerPage,
      rows: null,
      fields : [
        { key: 'id', label : 'id' },
  ...
  methods:{
    redirectToAddForm(){
       router.replace('/apps/sliders/add')
    },
    deleteItem(id=0){
    ...
    getRecords(){
      this.isLoading = true
      this.isBusy = true
      var url = `sliders?not_mobile=1&paginate=${this.perPage}&page=${this.currentPage}`
    ...
    paginateChanged(paginate){
      this.$store.state.appConfig.sliderListPerPage = paginate
      this.currentPage = 1
      this.isBusy = true
