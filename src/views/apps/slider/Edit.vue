            ...
            >
                 ...
                 <b-row>
                   ...
                   <!-- name ar -->
                    ...
                    <b-col md="6">
                      <b-row>
                        <b-col md="12" class="text-center mt-2 mb-2" v-if="image_en_preview">
                          <b-img thumbnail fluid :src="image_en_preview" style="max-width: 400px; height: auto;" />
                        </b-col>
                    ...
                    <b-col md="6">
                      ...
                      <b-row>  
                        ...
                        <b-col md="12" class="text-center mt-2 mb-2" v-if="image_ar_preview">
                          <b-img thumbnail fluid :src="image_ar_preview" style="max-width: 400px; height: auto;" />
                        </b-col>
...
export default {
  components: {
    ...
    BFormTextarea,
    BFormFile,
    BImg, ValidationProvider, ValidationObserver
  },
  directives: {
    Ripple,
  },
  ...
  mounted(){
        ...
        this.image_en_preview = response.data.data.image_path
        this.image_ar_preview = response.data.data.image_ar_path
        this.url_ar =  response.data.data.url_ar
  ...
  methods: {
    previewImage: function(event,lang) {
        var input = event.target;
        if (input.files) {
        var reader = new FileReader();
        reader.onload = (e) => {
            if(lang == 'en'){
              this.image_en_preview = e.target.result;
            }else{
               this.image_ar_preview = e.target.result;
            }
        }
    ...
    submitForm: function () {
        ...
        axios
          .post(`sliders/${this.id}`, formDataInputs, this.headersObj)
          .then(response => {
