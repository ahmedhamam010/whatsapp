...
export default {
  ...
  methods: {
    ...
    submitForm: function () {
        ...
        axios
          .post(`specialty/store`, formDataInputs, this.headersObj)
          .then(response => {
              console.log('specialty/store succuss' , response)
          ...
          .catch(error => {
            ...
            console.log('add specialty error' , error.response.data.message)
