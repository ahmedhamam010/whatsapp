            ...
            >
              ...
              <template #cell(actions)="data">
                ...
                <b-button
                  ...
                  :to="{ name: 'apps-pending-practical-tasks-view', params: { id: data.item.id , status : 'pending' } }"
                >
...
export default {
  ...
  data(){
    return{
      ...
      items: [],
      currentPage: 1,
      perPage: this.$store.state.appConfig.pendingTaskListPerPage,
      rows: null,
      fields : [
        { key: 'id', label : 'id' },
        { key: 'name', label : 'name' },
  ...
  methods:{
    ...
    getRecords(){
      this.isBusy = true
      this.isLoading = true
      var url = `practicalTasksUser/null/users/pending?paginate=${this.perPage}&page=${this.currentPage}`
    ...
    paginateChanged(paginate){
      this.$store.state.appConfig.pendingTaskListPerPage = paginate
      this.currentPage = 1
      this.isBusy = true
