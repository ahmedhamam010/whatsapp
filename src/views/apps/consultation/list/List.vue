      ...
      <b-card title="Consultants List" > 
            ...
            <template #cell(actions)="data">
                <b-button
                  ...
                  @click="changeConsultantStatus(data.item.consultant_info_id , 'accepted')"
                >
                ...
                <b-button
                  ...
                  @click="changeConsultantStatus(data.item.consultant_info_id , 'rejected')"
                >
...
export default {
  ...
  methods:{
    ...
    getRecords(){
      this.isBusy = true
      this.isLoading = true
      var url = `consultationInfos/requests?status=pending&paginate=${this.perPage}&name=${this.searchParameter}&page=${this.currentPage}`
