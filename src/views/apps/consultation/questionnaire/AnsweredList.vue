<template>
  <div class="position-relative">   
      ...
      <b-card title="Answered Questionnaires List" > 
            ...
            <template #cell(actions)="data">
                ...
                <b-button
                  ...
                  :to="{ name: 'apps-consultation-questionnaire-view', params: { id: data.item.id } }"
                >
...
export default {
  ...
  methods:{
    ...
    getRecords(){
      this.isBusy = true
      this.isLoading = true
      var url = `consultants/questionnaires?is_old=1&paginate=${this.perPage}&page=${this.currentPage}`
