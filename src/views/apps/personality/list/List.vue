  ...
  <div class="position-relative">   
      ...
      <b-card no-body > 
              ...
              <b-row>
                ...
                >
                  <div class="d-flex align-items-center justify-content-end">
                    ...
                    >
                      <span class="text-nowrap">Add Assessments Test</span>
                    </b-button>
                  </div>
                </b-col>
            ...
            >
              ...
              <template #cell(passing_percentage)="data">
                  {{ data.item.passing_percentage }}%
              </template>
              ...
              <template #cell(actions)="data">
                ...
                >
                  ...
                  <b-dropdown-item :to="{ name: 'apps-personality-view', params: { id: data.item.id } }">
                    <feather-icon icon="FileTextIcon" />
                    <span class="align-middle ml-50">Details</span>
                  </b-dropdown-item>
                  
                  <b-dropdown-item :to="{ name: 'apps-personality-edit', params: { id: data.item.id } }">
...
export default {
  ...
  data(){
    return{
      ...
      fields : [
        ...
        { key: 'passing_percentage', label : 'passing percentage' },
  ...
  methods:{
    redirectToAddForm(){
      router.replace('/apps/assesment/add/')
    },
    deleteItem(id=0){
    ...
    getRecords(){
      this.isBusy = true
      this.isLoading = true
      var url = `quizzes/index/personality?paginate=${this.perPage}&page=${this.currentPage}`
      ...
      .then(response => {
         console.log('personalty tests:' , response.data.quizzes )
         ...
         for( let i=0 ; i< data.length ; i++ ){
           this.items.push(
             { 
               ...
               passing_percentage : data[i].passing_percentage ,
               price : data[i].price ? data[i].price : 'Free' ,
               is_free : data[i].price ? 'No' : 'Yes' ,   
             })
         }
