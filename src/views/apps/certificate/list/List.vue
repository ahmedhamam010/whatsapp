<template>
  <div class="position-relative">   
      ...
      <b-card title="Certificates List" > 
            ...
            >
              ...
              <template #cell(actions)="data">
                ...
                >
                  ...
                  <b-dropdown-item :to="{ name: 'apps-certificates-view', params: { id: data.item.id } }">
                    <feather-icon icon="FileTextIcon" />
                    <span class="align-middle ml-50">Details</span>
                  </b-dropdown-item>
                  
                  <b-dropdown-item :to="{ name: 'apps-certificates-edit', params: { id: data.item.id } }">
...
export default {
  ...
  data(){
    return{
      ...
      items: [],
      currentPage: 1,
      perPage: this.$store.state.appConfig.certificateListPerPage,
      rows: null,
      fields : [
        { key: 'id', label : 'id'  },
  ...
  methods:{
    redirectToAddForm(){
      router.replace('/apps/certificates/add')
    },
    deleteItem(id=0){
            
      axios.delete(`certificates/${id}/delete`, 
        {
    ...
    getRecords(){
      this.isBusy = true
      this.isLoading = true
      var url = `certificates?paginate=${this.perPage}&page=${this.currentPage}`
    ...
    paginateChanged(paginate){
      this.$store.state.appConfig.certificateListPerPage = paginate
      this.currentPage = 1
      this.isBusy = true
