            ...
            >
              ...
              <template #cell(actions)="data">
                ...
                >
                  ...
                  <b-dropdown-item :to="{ name: 'apps-categories-view', params: { id: data.item.id } }">
                    <feather-icon icon="FileTextIcon" />
                    <span class="align-middle ml-50">Details</span>
                  </b-dropdown-item>
                  
                  <b-dropdown-item :to="{ name: 'apps-categories-edit', params: { id: data.item.id } }">
...
export default {
  ...
  data(){
    return{
      ...
      items: [],
      currentPage: 1,
      perPage: this.$store.state.appConfig.categoryListPerPage,
      rows: null,
      fields : [
        { key: 'id', label : 'id' },
  ...
  methods:{
    ...
    getRecords(){
      this.isBusy = true
      this.isLoading = true
      var url = `categories?paginate=${this.perPage}&page=${this.currentPage}`
      ...
      .then(response => {
         ...
         let data = response.data.categories.data;
         this.rows= response.data.categories.total
         this.perPage=response.data.categories.per_page
         this.dataMeta.from = response.data.categories.from
         this.dataMeta.to = response.data.categories.to
         this.dataMeta.of = response.data.categories.total
